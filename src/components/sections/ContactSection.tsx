  ...
  return (
    <section className="py-24 relative" id="contact">
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-1/4 -right-1/4 w-1/2 h-1/2 bg-devcode-purple/5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-1/4 -left-1/4 w-1/2 h-1/2 bg-devcode-blue/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <motion.div variants={itemVariants} className="glass-morphism rounded-xl p-8 h-full">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <motion.div variants={itemVariants} className="glass-morphism rounded-xl p-8">
